...
template<typename T>
inline void LinearRegression<T>::fit(const std::vector<std::vector<T>>& input_features, const std::vector<T>& target_variable) {
...
template<typename T>
inline T LinearRegression<T>::score(const std::vector<std::vector<T>>& input_features, const std::vector<T>& target_variable) const {
    if (input_features.size() != target_variable.size()) {
        throw std::invalid_argument("The size of input_features and target_variable must be equal.");
    }
...
template<typename T>
inline T LinearRegression<T>::covariance(const std::vector<T>& feature_values, const std::vector<T>& target_values) const {
...
template<typename T>
inline std::vector<T> LinearRegression<T>::compute_gradient(const std::vector<std::vector<T>>& input_features, const std::vector<T>& target_values) const {
...
template<typename T>
inline std::vector<std::vector<T>> LinearRegression<T>::normalize(const std::vector<std::vector<T>>& input_features) const {
